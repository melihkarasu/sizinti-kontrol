# 🛡️ Sızıntı Kontrolü & Güvenlik

HaveIBeenPwned k-Anonymity (SHA-1) protokolü ile sıfır bilgi garantili şifre sızıntı denetimi ve entropi analizi.
...
- **API Source:** Have I Been Pwned API
